            ...
            <ul class="sidebar menu">
                <li class="mini-posts">
                    <a href="#" class="tag">
                        ...
                        <img src="<?php bloginfo('template_directory'); ?>/img/mini1.jpg" alt="related post">
                    </a>
                </li>
                <li class="mini-posts">
                    <a href="#" class="tag">
                        <h5 class="mini-title">Easy (distr)action</h5>
                        <img src="<?php bloginfo('template_directory'); ?>/img/mini2.jpg" alt="related post">
                    </a>
                </li>
                <li class="mini-posts">
                    <a href="#" class="tag">
                        <h5 class="mini-title">Meditaion</h5>
                        <img src="<?php bloginfo('template_directory'); ?>/img/mini3.jpg" alt="related post">
                    </a>
                </li>
            </ul>
        </div>
